...
- [Awesome Book](https://github.com/Mike47ip/Awesome_Book/)
...
```sh
  cd my-folder
  git clone https://github.com/Mike47ip/Awesome_Book.git
```
...
This project is [MIT](https://github.com/Mike47ip/Awesome_Book/blob/main/LICENSE) licensed.
